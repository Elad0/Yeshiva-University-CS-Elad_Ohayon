	...
	void testHowisGreaterWorks() throws URISyntaxException {
		MinHeapImpl test= new MinHeapImpl();
		 ...
		 URI textUri1 = new URI("http://edu.yu.cs/com1320/txt");
		  ...
		  DocumentImpl textDocument = new DocumentImpl(textUri1, textString1, null);
		  
		  textDocument.setLastUseTime(1);
		  
		  URI textUri2 = new URI("http://edu.yu.cs/com1320/txt2");
		  String textString2 = "PIE PIE";
		  DocumentImpl textDocument2 = new DocumentImpl(textUri2, textString2, null);
		  ...
		  DocumentImpl textDocument3 = new DocumentImpl(textUri3, textString3, null);
		  ...
		  DocumentImpl textDocument4 = new DocumentImpl(textUri4, textString4, null);
