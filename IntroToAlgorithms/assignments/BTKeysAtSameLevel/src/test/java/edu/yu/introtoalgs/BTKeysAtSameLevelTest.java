...
public class BTKeysAtSameLevelTest extends BigOMeasurable {
...
public void unrelatedTest() {
	String[] array = new String[(int) Math.pow(2,2)];
char[] processed= "1234".toCharArray();
for(int i=0; i<processed.length; i++) {
	array[i]=String.valueOf(processed[i]);
}
